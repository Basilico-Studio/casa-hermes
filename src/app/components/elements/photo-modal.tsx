    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 hidden md:flex justify-center items-center z-50">
      <div className="w-4/5 h-[50%] flex flex-col">
        <div className="overflow-hidden aspect-square h-full flex flex-col rounded">
          <button className="absolute top-[50%] left-1 md:left-64" onClick={prevSlide}>
            <CaretLeft className="text-black rounded-full p-1 bg-white" size={32} />
          </button>
          <button className="absolute top-[50%] right-1 md:right-64" onClick={nextSlide}>
            <CaretRight className="text-black rounded-full p-1 bg-white" size={32} />
          </button>
          <button className="text-primary text-lg absolute top-[35%] md:top-[25%] right-1 md:right-64 " onClick={() => onClose()}>
